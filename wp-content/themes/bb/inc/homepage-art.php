<?php /* ############ SECTION FOR ART AND CULTURE  ############ */ ?>
<section class="container-fluid">
	<header class="container">
		<div class="page-header">
		<?php query_posts('cat=2 & posts_per_page=1');  while ( have_posts() ) : the_post();  ?>	
			<h1 class="pull-left"><?php $category = get_the_category(); echo $category[0]->cat_name; ?></h1>
	...
	<section class="container">
		...
		<?php query_posts('cat=2 & posts_per_page=4');  while ( have_posts() ) : the_post(); ?>	
